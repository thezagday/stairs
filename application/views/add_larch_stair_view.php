...
<div class="layout-content">
    <div class="layout-content-body">
        ...
        <p class="title-bar-description">Тут вы можете добавить информацию в раздел  "Лестницы из лиственницы"</p>
        <div class="row">
            <div class="col-md-8">
                <div class="demo-form-wrapper">
    <form action="add_larch_stair" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <button type="submit" class="btn-primary" id="input_btn" value="upload">Добавить</button>
        </div>
    </div>
    </form>
</div>
