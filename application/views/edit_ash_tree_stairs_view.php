...
<div class="layout-content">
    <div class="layout-content-body">
        ...
        <p class="title-bar-description">Тут вы можете отредактировать раздел "Лестницы из ясеня"</p>
        <div class="row">
            <div class="col-md-8">
                <div class="demo-form-wrapper">
                    <form action="add_ash_tree_stair" method="post" class="form form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="list-group">
                                        <a class="list-group-item" href="edit_ash_tree_stair?id=<?=$item['id']?>">
                                            <div class="media">
                                        ...
                                        <a class="list-group-item" href="delete_ash_tree_stair?id=<?=$item['id']?>">
                                            <div class="media">
                                                <div class="media-middle media-body">
