...
<div class="layout-content">
    <div class="layout-content-body">
        ...
        <p class="title-bar-description">Тут вы можете добавить информацию в раздел "Лестницы из сосны"</p>
        <div class="row">
            <div class="col-md-8">
                <div class="demo-form-wrapper">
                    <form action="add_pine_stair" method="post" class="form form-horizontal" enctype="multipart/form-data">
