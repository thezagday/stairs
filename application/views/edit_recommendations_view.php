        ...
        <div class="row">
            <div class="col-md-8">
                <div class="demo-form-wrapper">
                    <form action="add_recommendations" method="post" class="form form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="list-group">
                                        <a class="list-group-item" href="update_recommendations?id=<?=$item['id']?>">
                                            <div class="media">
                                        ...
                                        <a class="list-group-item" href="delete_recommendations?id=<?=$item['id']?>">
                                            <div class="media">
                                                <div class="media-middle media-body">
